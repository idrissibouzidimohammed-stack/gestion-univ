            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="number" name="cc1" value="{{ old('cc1') }}" min="0" max="20" step="0.25" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">CC2 /20</label>
                        <input type="number" name="cc2" value="{{ old('cc2') }}" min="0" max="20" step="0.25" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Examen /20</label>
                        <input type="number" name="examen" value="{{ old('examen') }}" min="0" max="20" step="0.25" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                </div>
